            ...
            <ul className='flex w-full gap-5 px-16 pt-20 mb-10'>
                <li key={food.id} className='flex w-1/2 mb-1 rounded-lg cursor-pointer bg-slate-800'>
                    ...
                    <div className='px-2 my-4 font-semibold'>
                        ...
                        <h1 className='text-xl'><i class="fa-solid fa-caret-right mr-3 text-amber-500"></i>{food.description}</h1>
                        <h1 className='pt-3 text-base italic font-normal text-slate-300'><i className="not-italic">Bahan: </i>{food.ingredients}</h1>
                    </div>
                </li>
